        ...
        <div class="flex flex-col bg-[#f8f9fa] border shadow-xl rounded-xl pointer-events-auto w-full overflow-hidden">
            ...
            <div class="bg-[#0f172a] px-5 py-4 flex items-center justify-between border-b border-slate-800">
                <div class="flex items-center gap-4">
                    <div class="w-8 h-8 rounded border border-green-500/30 flex items-center justify-center bg-transparent text-green-500">
                ...
                <div class="mb-4">
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="w-full bg-white border border-[#e2e8f0] overflow-x-auto overflow-y-auto max-h-[200px] rounded-xl shadow-sm relative">
                                    ...
                                    <table class="w-full text-left border-collapse">
                                        <thead class="sticky top-0 z-10">
                                            <tr class="bg-[#0f172a] text-white">
                                                ...
                                                <th class="px-3 py-2.5 text-[11px] font-bold uppercase tracking-wider">Uraian Pekerjaan</th>
                                                <th class="px-3 py-2.5 text-center text-[11px] font-bold uppercase tracking-wider w-24">Satuan</th>
                                                <th class="px-3 py-2.5 text-center text-[11px] font-bold uppercase tracking-wider w-28">Sisa Target</th>
                                                <th class="px-3 py-2.5 text-center text-[11px] font-bold uppercase tracking-wider w-32">Vol. Input</th>
            ...
            <div class="px-5 py-3 border-t border-slate-200 bg-white rounded-b-xl flex justify-end gap-3">
                <button type="button" class="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-bold rounded-xl transition-all" data-hs-overlay="#modal-tambah-realisasi">
                    Batal
                </button>
                <button type="button" id="btn-save-realisasi" class="px-6 py-2.5 bg-[#22c55e] hover:bg-green-600 text-white text-sm font-bold rounded-xl flex items-center justify-center gap-2 shadow-md transition-all">
                    Simpan Progres
                </button>
            </div>
