        ...
        <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-stretch gap-0.5 md:gap-0">
          <div class="grow">
            <div class="flex flex-col md:flex-row md:justify-end md:items-stretch gap-0.5 md:gap-0">
              <a class="<?= get_nav_class('dashboard') ?>" href="<?= base_url('dashboard') ?>" data-nav-path="dashboard" <?= is_nav_active('dashboard') ? 'aria-current="page"' : '' ?>>
              ...
              <a class="<?= get_nav_class('menu-rap') ?>" href="<?= base_url('proyek') ?>" data-nav-path="menu-rap" <?= is_nav_active('menu-rap') ? 'aria-current="page"' : '' ?>>
              ...
              <a class="<?= get_nav_class('monitoring') ?>" href="<?= base_url('monitoring') ?>" data-nav-path="monitoring" <?= is_nav_active('monitoring') ? 'aria-current="page"' : '' ?>>
