...
class PurchaseRequestItemModel extends Model
{
    ...
    {
        return $this->select('purchase_request_items.*, master_barang.nama_barang as nama_material, master_barang.satuan, master_barang.satuan_kemasan, master_barang.spesifikasi, master_barang.konversi_faktor, purchase_orders.po_number')
