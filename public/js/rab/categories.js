...
import { state, tbody, kategoriModalOverlay, kategoriModalList, kategoriModalInfo } from './state.js';
import { fetchKategoriMaster } from './data.js';
...
export function appendCategoryRow(cat) {
    ...
    bindEditableCategoryToggleRow(catTr);
}

function bindAddSubItemRow(catTr) {
...
function bindEditableCategoryToggleRow(catTr) {
