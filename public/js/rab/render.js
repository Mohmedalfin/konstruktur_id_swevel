 ...
 * totals, table visibility, editable mode toggle, and bind helpers.
 */

import { state, tbody, wrapper, searchInput, tambahKategoriBtn, totalJumlah, totalPpn, totalFinal } from './state.js';
