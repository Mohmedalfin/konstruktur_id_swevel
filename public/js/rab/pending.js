/**
 * rab/pending.js
 * Handles injecting pending items (from sessionStorage) into the RAB table
 * after returning from the Tambah AHS page, and restoring category rows.
 */

import { state, tbody } from './state.js';
import { fmt, escHtml } from '../shared/utils.js';
import { updateTotals } from './render.js';
import { appendCategoryRow } from './categories.js';
